...
if ! wp --path=/var/www/html --allow-root core is-installed 2>/dev/null; then
  ...
  echo "WP setup: already installed, skipping."
fi
...
echo "WP setup: uploads permissions fixed."
...
# --- Start PHP-FPM (WordPress is fully configured before this point) ---
